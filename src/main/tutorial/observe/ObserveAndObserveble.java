...
public class ObserveAndObserveble implements Observer<Person> {
    public static void main(String[] args) {
        new ObserveAndObserveble();
    }

    public ObserveAndObserveble(){
