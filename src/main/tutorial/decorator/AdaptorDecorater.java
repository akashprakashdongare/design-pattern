package main.tutorial.decorator;
...
class MyStringBuilder{
    ...
    public StringBuilder append(StringBuffer sba) {
        return sb.append(sba);
    }
...
public class AdaptorDecorater {
    public static void main(String[] args) {
        MyStringBuilder msb = new MyStringBuilder();
        msb.append("hello").appendLine(" word");
        System.out.println(msb.append("and this too"));
    }
}
